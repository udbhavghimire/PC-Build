...
?>
    ...
    <div class="row">
        <div class="">
            <h1 class="text-center py-5 text-primary">Psu List</h1> 
        </div>
...
while($row_psu = mysqli_fetch_array($run)){
  ...
  ?>
    ...
    <form action="" method="post">
      ...
      <input type="hidden" name="product_name" value="<?php echo $ps_name; ?>">
      <input type="hidden" name="product_price" value="<?php echo $ps_price; ?>">
